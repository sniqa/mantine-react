...
export default ({ opened, isBreakepoint = false }: SideNavbarProps) => {
...
const ExpanedNavbar = ({ language, menuList }: ExpanedNavbarProps) => {
	return (
		<>
			<Navbar.Section>
...
const ShrinkNavbar = ({ language, menuList }: ShrinkNavbarProps) => {
	const { isDarkModel } = useColorScheme()
