...
} & MantineReactTableCustomRowActionsProps<TData> &
	Omit<MantineReactTableCustomToolbarActionsProps<TData>, 'onUploadFile'>
			...
			<>
				<MantineReactTable
					...
					renderTopToolbarCustomActions={({ table }) => (
						<MantineCustomToolbarActions<TData>
							table={table}
							language={language}
							onCreate={onCreate}
							onDeleteSelection={onDeleteSelection}
